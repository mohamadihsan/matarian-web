...
class Unifikasi_Kode_Fasilitas extends CI_Controller {
    ...
    {
        $data['title'] = 'Master Kode Fasilitas';
        ...
        $this->load->view('pages/unifikasi_kode_fasilitas', $data);
        $this->load->view('_layout/footer');
    }

}

/* End of file Unifikasi_Kode_Fasilitas.php */
