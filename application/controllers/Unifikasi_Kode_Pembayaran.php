...
class Unifikasi_Kode_Pembayaran extends CI_Controller {
    ...
    {
        $data['title'] = 'Master Kode Pembayaran';
        ...
        $this->load->view('pages/unifikasi_kode_pembayaran', $data);
        $this->load->view('_layout/footer');
    }

}

/* End of file Unifikasi_Kode_Pembayaran.php */
