...
class Unifikasi_Kode_Objek_Pajak extends CI_Controller {
    ...
    {
        $data['title'] = 'Master Kode Objek Pajak';
        ...
        $this->load->view('pages/unifikasi_kode_objek_pajak', $data);
        $this->load->view('_layout/footer');
    }

}

/* End of file Unifikasi_Kode_Objek_Pajak.php */
