...
class Unifikasi_Kode_Dokumen extends CI_Controller {
    ...
    {
        $data['title'] = 'Master Kode Dokumen';
        ...
        $this->load->view('pages/unifikasi_kode_dokumen', $data);
        $this->load->view('_layout/footer');
    }

}

/* End of file Unifikasi_Kode_Dokumen.php */
