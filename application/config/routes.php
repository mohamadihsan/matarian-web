...
$route['api/web/v1/report/unifikasi/create']['POST']          = 'api/web/v1/Report_Api/unifikasi_create';
$route['api/web/v1/report/unifikasi/update/(:num)']['PUT']          = 'api/web/v1/Report_Api/unifikasi_update/$1';
