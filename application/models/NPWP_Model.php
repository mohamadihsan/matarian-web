...
class NPWP_Model extends CI_Model
{
    ...
    public function get($param = null)
    {
        ...
        $this->db->select('id, tipe_dokumen, npwp, new_npwp, nitku, nitku_digit, nik, nama, alamat, nomor, blok, rt, rw, kelurahan, kecamatan, kabupaten, provinsi, kodepos, nomor_telepon, created_by, created_at, updated_by, updated_at, created_by_user, updated_by_user');
