...
$(document).ready( function () {
    ...
    var table = $('#katapandaTable').DataTable({
        ...
        columns: [
            { data: "kode_langganan", className: "align-middle", responsivePriority: 1 },
            { data: "nama_toko", className: "align-middle", responsivePriority: 2 },
            { data: "alamat", className: "align-middle" },
            { data: "kota", className: "align-middle" },
            { data: "telepon", className: "align-middle" }
        ],
        language: {
