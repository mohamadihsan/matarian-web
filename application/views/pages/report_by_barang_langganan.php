...
$(document).ready( function () {
    ...
    var table = $('#katapandaTable').DataTable({
        ...
        order: [],
        columns: [
            { data: "nomor_nota", className: "align-middle", width: "80px", responsivePriority: 1, render : function ( data, type, row, meta ) {
                // let explode = data.split(',');
                
                return `<span class="font-weight-bold text-md">${data.replace(/,/g, '<br/>')}<span>`;
            }},
            { data: "tanggal_nota", className: "align-middle", width: "80px", responsivePriority: 4, render : function ( data, type, row, meta ) {
                // let explode = data.split(',');
                
                return moment(data, 'YYYY-MM-DD').format('DD-MM-YYYY');
            }},
            { data: "kode_langganan", className: "align-middle", width: "100px", responsivePriority: 3 },
            { data: "nama_langganan", className: "align-middle"},
            { data: "kode_barang", className: "align-middle" },
            ...
            { data: "harga_satuan", className: "align-middle text-right", width: "50px", render : function ( data, type, row, meta ) {
                return formatNumber(data);
            }},
            { data: "total", className: "align-middle text-right", width: "80px", responsivePriority: 2, render : function ( data, type, row, meta ) {
                return formatNumber(data);
            }},
        ],
        language: {
