...
<script>
    $(document).ready(function() {
        ...
        $('#statusPerkawinan').prop("checked", true);
        $('#statusPerkawinan2').prop("checked", false);
        ...
        $('#katapandaTable tbody').on('click', 'tr', function() {
            ...
            var ids = $.map(table.rows(this).data(), async function(item) {
                ...
                if (item.status_perkawinan !== null) {
            ...
            submitHandler: function(form) {
                ...
                axios({
                        ...
                        data: {
                            ...
                            tgl_lahir: moment($('#tanggalLahir').val(), 'DD-MM-YYYY').format('YYYY-MM-DD'),
