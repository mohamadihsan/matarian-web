...
$(document).ready( function () {
    ...
    var table = $('#katapandaTable').DataTable({
        ...
        order: [],
        columns: [
            { data: "sales_ar", className: "align-middle", responsivePriority: 1 },
            { data: "nomor_nota", className: "align-middle" },
            { data: "tanggal", className: "align-middle", render : function ( data, type, row, meta ) {
                let date = data !== null ? moment(data, 'YYYY-MM-DD').format('DD-MM-YYYY') : 0;
                return date;
            }},
            { data: "kode_langganan", className: "align-middle" },
            { data: "nama_langganan", className: "align-middle", responsivePriority: 2 },
            { data: "kota", className: "align-middle" },
            { data: "nilai_faktur", className: "align-middle text-right", responsivePriority: 3, render : function ( data, type, row, meta ) {
