...
$(document).ready( function () {
    ...
    var table = $('#katapandaTable').DataTable({
        ...
        order: [],
        columns: [
            { data: "id", className: "align-middle", responsivePriority: 1, width:"10px", render : function ( data, type, row, meta ) {
                return no++;
            }},
            { data: "nomor_nota", className: "align-middle" },
            { data: "tanggal_nota", className: "align-middle", responsivePriority: 1, render : function ( data, type, row, meta ) {
                let date = data !== null ? moment(data, 'YYYY-MM-DD').format('DD-MM-YYYY') : 0;
                return date;
            }},
            { data: "dpp", className: "align-middle text-right", responsivePriority: 3, render : function ( data, type, row, meta ) {
            ...
            { data: "ppn", className: "align-middle text-right", responsivePriority: 4, render : function ( data, type, row, meta ) {
                if (row.nomor_nota == 'BAYAR' || row.nomor_nota == 'LEBIH' || row.nomor_nota == 'TITIP') {
                  return '-';  
                } else {
                    let number = data !== null ? formatNumber(data) : 0;
            ...
            { data: "nilai_nota", className: "align-middle text-right", responsivePriority: 5, render : function ( data, type, row, meta ) {
                let number = data !== null ? formatNumber(data) : 0;
                return number;
            }},
            { data: "nomor_nota", className: "align-middle text-center", responsivePriority: 2, width: "5%", render : function ( data, type, row, meta ) {
