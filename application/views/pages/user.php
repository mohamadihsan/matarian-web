            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        actionDelete && $.inArray(data, ["1", "104"]) === -1 ? action += `<button class="btn btn-sm btn-outline-danger delete" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fas fa-trash"></i></button>` : '';
                        action += `</div>`;
                        return action;
                    }
                },
