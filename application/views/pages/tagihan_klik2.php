...
$(document).ready( function () {
    ...
    var table = $('#katapandaTable').DataTable({
        ...
        columns: [
            { data: "kode_ar", className: "align-middle", responsivePriority: 1 },
            { data: "nama_toko", className: "align-middle" },
            { data: "kota", className: "align-middle" },
            { data: "jumlah_nota", className: "align-middle text-center", responsivePriority: 3, render : function ( data, type, row, meta ) {
                let number = data !== null ? formatNumber(data) : 0;
                return number + ' NOTA';
            }},
            { data: "total_tagihan", className: "align-middle text-right", responsivePriority: 4, render : function ( data, type, row, meta ) {
                let number = data !== null ? formatNumber(data) : 0;
                return number;
            }},
            { data: "kode_ar", className: "align-middle text-center", responsivePriority: 2, width: "5%", render : function ( data, type, row, meta ) {
